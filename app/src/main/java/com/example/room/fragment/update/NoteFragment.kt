...
class noteFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.editTitle.setText(args.currentNote.title)
        binding.editContent.setText(args.currentNote.content)
    ...
    private fun insertDataToDatabase(){
        ...
        if (!title.isEmpty()){
            ...
            Toast.makeText(requireContext(), "Failed to added!", Toast.LENGTH_SHORT).show()
        }
    }
}